<?php /* Smarty version Smarty-3.1.6, created on 2016-12-10 10:29:58
         compiled from "D:/xampp/htdocs/medpss/Admin/View\Trade\sales.html" */ ?>
<?php /*%%SmartyHeaderCode:2175584ae7bb6ad193-22967088%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'edd92494afb467c36138e28e619da623d04a298d' => 
    array (
      0 => 'D:/xampp/htdocs/medpss/Admin/View\\Trade\\sales.html',
      1 => 1481336987,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2175584ae7bb6ad193-22967088',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_584ae7bb75abe',
  'variables' => 
  array (
    'orderCode' => 0,
    'cus_info' => 0,
...
<?php if ($_valid && !is_callable('content_584ae7bb75abe')) {function content_584ae7bb75abe($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\xampp\\htdocs\\ThinkPHP\\Library\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
...
<!--        <td><?php echo $_smarty_tpl->tpl_vars['v']->value['med_manufacturer'];?>
        ...
        <td class="count">
          ...
          <!-- <input type="text" name="" value="<?php echo $_smarty_tpl->tpl_vars['v']->value['med_inventory'];?>
"/> -->
...
<!--        <input type="hidden" id="subtotal" name="subtotal[]"/>-->
        ...
        <input type="hidden" name="med_inventory[]" value="<?php echo $_smarty_tpl->tpl_vars['v']->value['med_inventory'];?>
"/>
...
<!--    </div>-->
    ...
    // function abc(){
    //     // alert("sdoiqjw");
    //     if(document.getElementById("fm")count>med_inventory){
    //         alert("库存不足，提交失败");
    //     }else{
